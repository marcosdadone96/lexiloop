          ...
          segments: [
            {
              label: 'Speaker 1',
              transcript:
                'I\'m tired of hearing that a play\'s worth can be counted in ticket sales and cafe receipts. If we only fund what fills seats, we\'ll end up with endless revivals and nothing that unsettles us. Culture isn\'t a productivity metric.',
              questions: [matchOpt('l15', '15  Speaker 1', 'A')],
            },
            {
              label: 'Speaker 2',
      ...
      sprechenParts: [
        ...
        },
        {
          ...
          photoDescriptions: [
            ...
            'Photo D: A solitary writer editing manuscript pages in a crowded cafe, wearing headphones.',
          ],
